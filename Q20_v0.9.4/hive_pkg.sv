...
package hive_params;
	...
	// DPLL params
	// pitch axis
	parameter	real	P_LC_FREQ		= 300000;	// lc res. frequency (1mH)
	parameter	real	P_LC_Q			= 150;		// lc res. quality factor (loop BW)
	...
	// volume axis
	parameter	real	V_LC_FREQ		= 425000;	// lc res. frequency (2mH)
	parameter	real	V_LC_Q			= 150;		// lc res. quality factor (loop BW)
